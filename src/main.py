...
from async_node import AlgorithmAsyncNode
...
def on_message_callback_debug(node_identifier, message_body):
    # See messages arriving in this simulation
    print('Received:', message_body, 'at node', node_identifier)
